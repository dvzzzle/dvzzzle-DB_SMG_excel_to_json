...
def convert_excel_to_json(excel_file_path):
    ...
    for sheet_name in sheets_to_process:
        if sheet_name in xls.sheet_names:
            ...
            df.rename(columns={
                "Получение ТУ от ресурсоснабжающих организаций (факт)": "Получение ТУ от РСО (факт)",
                "Разработка и получение положительного заключения экспертизы ПСД (факт)": "Разработка и экспертиза ПСД (факт)",
                "Начато производство СМР": "Производство СМР (факт)"
            }, inplace=True)
