    ...
    for sheet_name in xls.sheet_names:
        ...
        if sheet_name == "5 - ОИВ факт":
            ...
            columns_to_rename = {
                ...
                "Производство СМР (факт)": "ЭТАПРЕАЛИЗАЦИИ СМР (факт)",
...
convert_excel_to_json('E://Загрузки//Telegram Desktop//Текущая обработка//ДСТИИ_итоговый_перечень_для_ДБ_28_02_2025_с_АИП (2).xlsx')
