...
def convert_excel_to_json(excel_file_path):
    ...
    for sheet_name in xls.sheet_names:
        ...
        df.rename(columns={
            "Получение ТУ от ресурсоснабжающих организаций (факт)": "Получение ТУ от РСО",
            "Разработка и получение положительного заключения экспертизы ПСД (факт)": "Разработка и экспертиза ПСД"
        }, inplace=True)
...
convert_excel_to_json('E://Загрузки//Telegram Desktop//Текущая обработка//ДСТИИ_итоговый_перечень_для_ДБ_03_02_2025_с_АИП_и_культурой_первичный.xlsx')
