                ...
                for key, value in record.items():
                    ...
                    if key.strip() in keys_to_modify:
                        ...
                        if any(phrase in key.strip() for phrase in [
                            ...
                            'Получение ЗОС', 'Получение РВ', 'СТРОИТЕЛЬНАЯ ГОТОВНОСТЬ', 'Начато производство СМР'
                        ]):
...
convert_excel_to_json('E://Загрузки//Telegram Desktop//ДРНТ_итоговый_перечень_для_ДБ_04_03_2025_с_АИП_и_культурой (2).xlsx')
