                ...
                for key, value in record.items():
                    ...
                    if key.strip() in keys_to_modify:
                        ...
                        if any(phrase in key.strip() for phrase in [
                            ...
                            'Получение ЗОС', 'Получение РВ', 'СТРОИТЕЛЬНАЯ ГОТОВНОСТЬ', 'Производство СМР'
                        ]):
...
convert_excel_to_json('E://Загрузки//Telegram Desktop//ДГС_итоговый_перечень_для_ДБ_12_03_2024_с_АИП_и_культурой_СМГ_склиф (2).xlsx')
