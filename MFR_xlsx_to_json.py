    ...
    for sheet_name in sheets_to_process:
        if sheet_name in xls.sheet_names:
            if sheet_name == "6 - ОИВ КТ":
                ...
                headers = [
                    [header.replace("Технологическое присовединение (выполнение работ)", "Технологическое присоединение") 
                    if isinstance(header, str) else header 
                    for col_idx, header in enumerate(row) if col_idx not in columns_to_drop]
                    for row in headers
                ]
                data_rows = [
                ...
                if sheet_name == "5 - ОИВ факт":
                    ...
                    df['СТРОИТЕЛЬНАЯ ГОТОВНОСТЬ (план)'] = df['СТРОИТЕЛЬНАЯ ГОТОВНОСТЬ (план)'].str.replace(',', '.').fillna(0).astype(float).replace(0, None)
                    df['СТРОИТЕЛЬНАЯ ГОТОВНОСТЬ (факт)'] = df['СТРОИТЕЛЬНАЯ ГОТОВНОСТЬ (факт)'].str.replace(',', '.').fillna(0).astype(float).replace(0, None)
                ...
                keys_to_modify = [
                    "Строительная готовность (плановая дата начала)", "Строительная готовность (плановая дата завершения)",
                    "Конструктив (плановая дата начала)", "Конструктив (плановая дата завершения)", 
                    "Устройство котлована (плановая дата начала)", "Устройство котлована (плановая дата завершения)", 
                    "Устройство фундамента (плановая дата начала)", "Устройство фундамента (плановая дата завершения)", 
                    "Устройство ж/б конструкций (плановая дата начала)", "Устройство ж/б конструкций (плановая дата завершения)", 
                    "Устройство конструкций кровли (плановая дата начала)", "Устройство конструкций кровли (плановая дата завершения)", 
                    "Стены и перегородки (плановая дата начала)", "Стены и перегородки (плановая дата завершения)", "Наружные стены (плановая дата начала)",
                    "Наружные стены (плановая дата завершения)", "Внутренние перегородки (плановая дата начала)", 
                    "Внутренние перегородки (плановая дата завершения)", "Фасад (плановая дата начала)", "Фасад (плановая дата завершения)", 
                    "Фасадная система (плановая дата начала)", "Фасадная система (плановая дата завершения)", "Заполнение проемов (плановая дата начала)", 
                    "Заполнение проемов (плановая дата завершения)", "Внутренние сети (плановая дата начала)", "Внутренние сети (плановая дата завершения)", 
                    "Вентиляция (плановая дата начала)", "Вентиляция (плановая дата завершения)", "Электрика (плановая дата начала)", "Электрика (плановая дата завершения)", 
                    "Сантехника (плановая дата начала)", "Сантехника (плановая дата завершения)", "Сети связи (плановая дата начала)", 
                    "Сети связи (плановая дата завершения)", "Наружные сети (плановая дата начала)", "Наружные сети (плановая дата завершения)", 
                    "Теплосеть (плановая дата начала)", "Теплосеть (плановая дата завершения)", "Водоснабжение (плановая дата начала)", 
                    "Водоснабжение (плановая дата завершения)", "Х/Б канализация (плановая дата начала)", "Х/Б канализация (плановая дата завершения)", 
                    "Ливневая канализация (плановая дата начала)", "Ливневая канализация (плановая дата завершения)", "Электроснабжение (плановая дата начала)", 
                    "Электроснабжение (плановая дата завершения)", "Слаботочные сети (плановая дата начала)", "Слаботочные сети (плановая дата завершения)", 
                    "Оборудование по ТХЗ (плановая дата начала)", "Оборудование по ТХЗ (плановая дата завершения)", "Лифты (плановая дата начала)", 
                    "Лифты (плановая дата завершения)", "Мебель (плановая дата начала)", "Мебель (плановая дата завершения)", "Благоустройство (плановая дата начала)",
                    "Благоустройство (плановая дата завершения)", "Твердое покрытие (плановая дата начала)", "Твердое покрытие (плановая дата завершения)", 
                    "Озеленение (плановая дата начала)", "Озеленение (плановая дата завершения)",
                    "Строительная готовность (план)", "Строительная готовность (факт)",
                    "Конструктив (план)", "Конструктив (факт)", "Устройство котлована (план)",
                    "Устройство котлована (факт)", "Устройство фундамента (план)", 
                    "Устройство фундамента (факт)", "Устройство ж/б конструкций (план)", 
                    "Устройство ж/б конструкций (факт)", "Устройство конструкций кровли (план)",
                    "Устройство конструкций кровли (факт)", "Стены и перегородки (план)", "Стены и перегородки (факт)", 
                    "Наружные стены (план)", "Наружные стены (факт)", "Внутренние перегородки (план)", 
                    "Внутренние перегородки (факт)", "Фасад (план)", "Фасад (факт)", "Утеплитель (план)", "Утеплитель (факт)", 
                    "Фасадная система (план)", "Фасадная система (факт)", "Навесные элементы фасада (план)", "Навесные элементы фасада (факт)", 
                    "Заполнение проемов (план)", "Заполнение проемов (факт)", "Внутренние сети (план)", "Внутренние сети (факт)", 
                    "Вентиляция (план)", "Вентиляция (факт)", "Электрика (план)", "Электрика (факт)", "Сантехника (план)", 
                    "Сантехника (факт)", "Сети связи (план)", "Сети связи (факт)", "Наружные сети (план)", 
                    "Наружные сети (факт)", "Теплосеть (план)", "Теплосеть (факт)", "Водоснабжение (план)", "Водоснабжение (факт)", 
                    "Х/Б канализация (план)", "Х/Б канализация (факт)", "Ливневая канализация (план)", "Ливневая канализация (факт)", 
                    "Электроснабжение (план)", "Электроснабжение (факт)", "Слаботочные сети (план)", "Слаботочные сети (факт)", 
                    "Оборудование по ТХЗ (план)", "Оборудование по ТХЗ (факт)", "Лифты (план)", "Лифты (факт)", "Мебель (план)", 
                    "Мебель (факт)", "Благоустройство (план)", "Благоустройство (факт)", "Твердое покрытие (план)", 
                    "Твердое покрытие (факт)", "Озеленение (план)", "Озеленение (факт)",
...
convert_excel_to_json('E://Загрузки//Telegram Desktop//Текущая обработка//МФР_для_ДБ_2024_2027_год_10.04.2025 в2.xlsx')